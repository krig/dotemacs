(custom-set-variables
 ...
 '(notmuch-saved-searches (quote ((:name "inbox" :query "tag:inbox" :key "i") (:name "unread" :query "tag:unread" :key "u") (:name "flagged" :query "tag:flagged" :key "f") (:name "sent" :query "tag:sent" :key "t") (:name "drafts" :query "tag:draft" :key "d") (:name "all mail" :query "*" :key "a") (:name "unread-list" :query "tag:list and tag:unread") (:name "unread-fedora" :query "tag:fedora and tag:unread"))))
 ...
 '(sml/inactive-background-color "#e5eaf0")
 ...
 '(vc-annotate-color-map (quote ((30 . "#e74c3c") (60 . "#c0392b") (90 . "#e67e22") (120 . "#d35400") (150 . "#f1c40f") (180 . "#f39c12") (210 . "#2ecc71") (240 . "#27ae60") (270 . "#1abc9c") (300 . "#16a085") (330 . "#3498db") (360 . "#2980b9"))))
 '(vc-annotate-very-old-color "#2980b9"))
(custom-set-faces
