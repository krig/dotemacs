;;; mark-theme.el --- Emacs 24 theme with a light background.

;; Copyright (C) 2015 , mark feller

;; Author: mark feller
;; https://github.com/mjfeller/mark-theme
;; Version: 0.1
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:box (:line-width 1 :color ,bg3 :style none) :bold t :foreground ,fg2 :background ,bg2))))
