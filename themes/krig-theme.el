...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((,class (:foreground ,(krig-theme-paren-clr 1)))))
   `(rainbow-delimiters-depth-2-face ((,class (:foreground ,(krig-theme-paren-clr 2)))))
   `(rainbow-delimiters-depth-3-face ((,class (:foreground ,(krig-theme-paren-clr 3)))))
   `(rainbow-delimiters-depth-4-face ((,class (:foreground ,(krig-theme-paren-clr 4)))))
   `(rainbow-delimiters-depth-5-face ((,class (:foreground ,(krig-theme-paren-clr 5)))))
   `(rainbow-delimiters-depth-6-face ((,class (:foreground ,(krig-theme-paren-clr 6)))))
   `(rainbow-delimiters-depth-7-face ((,class (:foreground ,(krig-theme-paren-clr 7)))))
   `(rainbow-delimiters-depth-8-face ((,class (:foreground ,(krig-theme-paren-clr 8)))))
   `(rainbow-delimiters-depth-9-face ((,class (:foreground ,(krig-theme-paren-clr 9)))))
   ...
   `(py-builtins-face ((,class (:foreground ,foreground :weight normal))))
