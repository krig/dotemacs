  ...
  '(
    (t
     (:inherit tabbar-default-face
               :box (:line-width 1 :color "#666666" :style pressed-button)
               )
     )
    )
...
(defface tabbar-selected-face
  '(
    (t
     (:inherit tabbar-default-face
               :box (:line-width 1 :color "#aaaaaa" :style released-button)
               :foreground "#eeeeeb"
               )
     )
    )
...
(defface tabbar-button-face
  '(
    (t
     (:inherit tabbar-default-face
               :box (:line-width 1 :color "#888888" :style released-button)
               :foreground "#ff7f00"
               )
     )
    )
